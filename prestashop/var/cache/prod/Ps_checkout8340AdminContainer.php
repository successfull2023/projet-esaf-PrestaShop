...
class Ps_checkout8340AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.0', 'C:\\xampp\\htdocs\\prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.1.0', 'C:\\xampp\\htdocs\\prestashop');
    }
